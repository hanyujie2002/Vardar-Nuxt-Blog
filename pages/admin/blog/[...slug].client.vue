  ...
  <div class="flex flex-col w-[calc(100vw-10px)] justify-center items-center">
    <div class="max-w-7xl w-full flex">
      <div class="w-full flex mx-2 bg-gray-200 rounded-t">
        <button @click="updateFile" class="bg-green-200 text-slate-800 hover:brightness-95 active:brightness-90 px-3 py-2 rounded font-extralight my-2 ml-auto mr-2">Update</button>
      </div>
    </div>
...
const sha = ref('')
const articleUrl = 'https://api.github.com/repos/hanyujie2002/Vardar-Nuxt-Blog/contents/content' + stripedPath + '.md?ref=main'
